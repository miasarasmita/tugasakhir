        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">TAMBAH DATA LAHAN</h2>
                </div>
                <div class="card-body ">
                    <form action="{{ url('admin/lahan/addAction') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-group-doubleselect">
                                        <input type="number" name="luas" class="form-control" placeholder="Luas ..." required autocomplete="off">
                                        <select name="satuan_luas" id="" class="form-control">
                                            <option value="Meter">Meter</option>
                                            <option value="Kilo Meter">Kilo Meter</option>
                                            <option value="Hektare">Hektare</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="gambar" class="form-control" placeholder="Gambar ..." required autocomplete="off">
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group" data-toggle="modal" data-target="#modalOpenMaps">
                                    <label>Lokasi</label>
                                    <input type="text" name="lokasi" id="alamat" class="form-control" placeholder="Lokasi ..." required autocomplete="off" readonly>
                                    <input type="hidden" name="lat" id="latdata" class="form-control" placeholder="Lokasi ...">
                                    <input type="hidden" name="lng" id="lngdata" class="form-control" placeholder="Lokasi ...">
                                    <input type="hidden" name="kategori" id="kategori" class="form-control" placeholder="Kategori ...">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Banyak pengairan</label>
                                    <input type="text" name="banyak_pengairan" class="form-control" placeholder="Banyak pengairan ..." required autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tekstur" class="form-control" placeholder="Teksur tanah ..." required autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ph_tanah" class="form-control" placeholder="Ph Tanah ..." required autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-12">
